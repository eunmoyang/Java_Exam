...
public class RoomTest5 {
	static Scanner scan = new Scanner(System.in);
	
	public static void main(String[] args) {
		
		String[][] info = {
			{"Standard1", "Standard2", "Standard3", "Deluxe1", "Deluxe2", "Deluxe3", "Family1", "Family2", "Family3", "Suite1", "Suite2", "Suite3"}, // 방이름
			{"", "", "", "", "", "", "", "", "", "", "", ""}, // 예약자명
			{"", "", "", "", "", "", "", "", "", "", "", ""}, // 예약자 휴대전화 번호
			{"", "", "", "", "", "", "", "", "", "", "", ""}}; // 예약자 비밀번호
		...
		while(booking) {
			...
			case 1:
				...
				break;
			case 2:
				reservation(info, number);
				break;
			case 3:
				cancelation(info, number);
				break;
			case 4:
				confirmation(info, number);
				break;
			case 99:
	...
	private static void roomStatus(String[][] info, int[][] number) {
			int count = 0;
			int line = 3;
	...
	private static void reservation(String[][] info, int[][] number) {
		roomStatus(info, number);
		System.out.println("=========================");
